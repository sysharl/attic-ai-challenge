        ...
        with pdfplumber.open(file_path) as pdf:
            ...
            for i, page in enumerate(pdf.pages):
                ...
                try:
                    ...
                    logging.warning(f"Warning: Could not extract page {i+1}: {page_err}")
...
def chunk_fixed(text_blocks: list, filename: str, chunk_size=CHUNK_SIZE, overlap=CHUNK_OVERLAP) -> list:
    """
...
def chunk_recursive(text_blocks: list, filename: str, chunk_size=CHUNK_SIZE, overlap=CHUNK_OVERLAP) -> list:
    if not text_blocks:
